...
@test "assert_file_contains" {
  ...
  assert_file_contains "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" "some EXISTING text"
  assert_file_contains --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" "some existing text"
  assert_file_contains --regex "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'one more [a-z]+ of'
  assert_file_contains --format "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" "one %s line of existing text"
  ...
  run assert_file_contains --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" "some EXISTING text"
  assert_failure
...
@test "assert_file_not_contains" {
  ...
  assert_file_not_contains --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" "some EXISTING text"
  assert_file_not_contains --regex "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'existing [0-9]+'
  ...
  run assert_file_not_contains --regex "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'one more [a-z]+ of'
  assert_failure
...
@test "assert_file_matches" {
  ...
  assert_file_matches "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'DELETED [0-9]+ files'
  assert_file_matches --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'Deleted [0-9]+ files'
  ...
  run assert_file_matches --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'DELETED [0-9]+ files'
  assert_failure
}
...
@test "assert_file_not_matches" {
  ...
  assert_file_not_matches --case-sensitive "${BATS_TEST_TMPDIR}/fixture_file_assert/1.txt" 'DELETED [0-9]+ files'
